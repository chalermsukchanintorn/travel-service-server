...
//     }
// };
//กรณีมีการอัปโหลดไฟล์ แต่จะเลือกรูปเพื่ออัปโหลดหรือไม่เลือก ก็ได้ก็จะเก็บค่าว่างแทน
exports.createTraveller = async (req, res) => {
  try {
...
//   }
// };
//กรณีมีการอัปโหลดไฟล์ แต่จะเลือกรูปเพื่ออัปโหลดเพื่อแก้ไข หรือไม่เลือกก็ได้ก็จะเก็บค่าเดิมแทน
exports.editTraveller = async (req, res) => {
  try {
    //ตัวแปรเก็บข้อมูลที่ส่งมากับข้อมูลรูปภาพที่จะเอาไปบันทึกใน Table
    let data = {
